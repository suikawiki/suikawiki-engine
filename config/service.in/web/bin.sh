...
export WEBUA_DEBUG=`@@ROOT@@/perl @@ROOT@@/modules/SWE/modules/karasuma-config/bin/get-json-config.pl env_WEBUA_DEBUG text`
port=`@@ROOT@@/perl @@ROOT@@/modules/SWE/modules/karasuma-config/bin/get-json-config.pl web_port text`
