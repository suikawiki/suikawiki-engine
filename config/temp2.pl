...
our $cvs_archives_url = q</gate/cvs/melon/pub/test/sw5/>;

our $sw3_db_dir_name = q[/home/wakaba/server/sw3/wikidata/page/];
our $db_dir_name = $root_d->subdir ('testdata')->absolute->stringify . '/';

our $apache_modules_dir_name = q[/usr/lib64/httpd/modules];
our $apache_server_name = q[suikawiki];
our $apache_server_port = 10083;
our $apache_server_admin = q[webmaster@suika.fam.cx];

our $sw_script_name = q[/~wakaba/temp2/sw5];

our $edit_realm = q[SuikaWiki test];
